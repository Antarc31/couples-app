      ...
      <Card className="flex flex-col gap-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <h2 className="text-xl leading-none text-ink">Ricordi</h2>
            {thoughts.length > 1 && (
        ...
        {!loading && !error && thoughts.length > 0 && topIndex === thoughts.length - 1 && (
          <div className="flex items-center justify-between gap-2 rounded-2xl border border-dashed border-[color:var(--color-border)] bg-surface py-2 pl-3 pr-14">
